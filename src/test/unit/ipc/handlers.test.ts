...
vi.mock('@/main/services/local-cache.service', () => svc({ getCacheUrl: vi.fn(), getCacheStatus: vi.fn(), clearCache: vi.fn() }))
...
vi.mock('@/main/services/dami-tv.service', () => svc({ getChannels: vi.fn(), getAvailableCountries: vi.fn(), extractChannelUrl: vi.fn() }))
